...
/// This function verifies the expected directory exists before persisting state.
/// Called after engine.next() but before state.save() — prevents invalid state on disk.
